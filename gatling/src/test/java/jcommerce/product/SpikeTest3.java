...
public class SpikeTest3 extends Simulation {
    final static String PRODUCT_URL = "http://localhost:8081";

    final static int TARGET_RPS = 400;
    ...
    ScenarioBuilder productScenario = scenario("Catalogue Spike Test 3")
            ...
            .on(
                    ...
                    exec(http("Catalogue Spike Test 3")
                            .post("/api/v2/graphql")
